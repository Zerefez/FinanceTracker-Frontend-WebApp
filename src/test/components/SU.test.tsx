...
describe('SU Component', () => {
  ...
  describe('SUSection with props', () => {
    ...
    it('renders with custom taxCard value', () => {
      render(
        <SUSection 
          taxCard={TAX_CARD_OPTIONS.SECONDARY.value}
        />
      );
    ...
    it('renders with custom housingStatus value', () => {
      render(
        <SUSection 
          housingStatus={HOUSING_STATUS.WITH_PARENTS.value}
        />
      );
    ...
    it('calls onTaxCardChange when tax card is changed', () => {
      render(
        <SUSection 
          taxCard={TAX_CARD_OPTIONS.MAIN.value}
          onTaxCardChange={mockOnTaxCardChange}
        />
      );
    ...
    it('shows correct remaining earnings', () => {
      ...
      const remainingValueElement = remainingLabel.parentElement?.querySelector('.font-semibold.text-accent');
